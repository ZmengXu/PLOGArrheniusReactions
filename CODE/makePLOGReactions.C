...
namespace Foam
{
    ...
    forCommonGases(makeIRReactions, ArrheniusPLOGReactionRate);
    forCommonLiquids(makeIRReactions, ArrheniusPLOGReactionRate);
    forPolynomials(makeIRReactions, ArrheniusPLOGReactionRate);
}
